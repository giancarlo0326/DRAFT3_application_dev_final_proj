        ...
        <div class="centered-container">
            ...
            <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="inputAddress" placeholder="100 Nicanor Reyes St. Sampaloc, Manila">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" class="form-control" id="inputEmail4" placeholder="someone@domain.com">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control" id="inputZip" placeholder="1008">
                </div>
                <div class="col-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="gridCheck">
                        <label class="form-check-label" for="gridCheck">
                            By signing up, I hereby agree to the terms and conditions of PUIHAHA Videos Limited.
                        </label>
                    </div>
                </div>
                <div class="col-12">
